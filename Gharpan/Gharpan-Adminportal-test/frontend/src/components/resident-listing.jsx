...
const ResidentsListing = () => {
  ...
  const fetchResidents = async (page = 1, search = "", appliedFilters = {}, sort = { field: sortField, order: sortOrder }) => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:5000/api/residents?${params.toString()}`,
        {
  ...
  const updateResidentData = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:5000/api/residents/${updateResident._id}`,
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const exportToExcel = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:5000/api/residents/export?${params.toString()}`,
        {
          method: "GET",
          headers: {
            "Content-Type": "application/json",
  ...
  const downloadResidentDetails = async (
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:5000/api/residents/${residentId}/download?format=pdf&template=detailed`
      );
  ...
  const printResidentDetails = async (
    ...
    try {
      ...
      const printUrl = `http://localhost:5000/api/residents/${residentId}/print?template=detailed`;
  ...
  const previewResidentDetails = async (
    ...
    try {
      ...
      const previewUrl = `http://localhost:5000/api/residents/${residentId}/preview`;
